...
// all photos to import for project
import './App.css';
...
function App() {
    ...
    const responseGoogle = (response) => {
        ...
        changePage({loginpage:"none",signuppage:"none",page1:"block",page2:"none",pagevid:"none",pagepayment:"none",profilepage:"none",modaleFail:"none",modaleSuccess:"none",dealspage:"none",modalecartempty:"none"})
    }
    ...
    return(
        <>
        {/* modale empty cart*/}
        <div className="check-modale-success" style={{display:page.modalecartempty}}>
            <div className="check-modale-inner">
                <div className="check-modale-inner-display">
                    <div className="check-modale-div-top">
                        <i class="fas fa-times fa-2x cross-alert" onClick={()=>changePage({loginpage:"none",signuppage:"none",page1:"block",page2:"none",pagevid:"none",pagepayment:"none",profilepage:"none",modaleFail:"none",modaleSuccess:"none",dealspage:"none",modalecartempty:"none"})}></i>
                    </div>
                    <div className="hrtag"></div>
                    <div className="check-modale-div-bottom">
                    <i class="fas fa-exclamation-triangle" style={{color:"red"}}></i>{'\u00A0'}Cart is Empty !
                    </div>
                </div>
            </div>
        </div>
        ...
        <div className="check-modale-success" style={{display:page.modaleSuccess}}>
            <div className="check-modale-inner">
                <div className="check-modale-inner-display">
                    <div className="check-modale-div-top">
                        <i class="fas fa-times fa-2x cross-alert" onClick={()=>changePage({loginpage:"none",signuppage:"none",page1:"none",page2:"none",pagevid:"none",pagepayment:"none",profilepage:"block",modaleFail:"none",modaleSuccess:"none",dealspage:"none",modalecartempty:"none"})}></i>
                    </div>
                    <div className="hrtag"></div>
                    <div className="check-modale-div-bottom">
        ...
        <div className="check-modale-fail" style={{display:page.modaleFail}}>
            <div className="check-modale-inner">
                <div className="check-modale-inner-display">
                    ...
                    <div className="hrtag"></div>
                    <div className="check-modale-div-bottom">
                    <i class="fas fa-exclamation-triangle" style={{color:"red"}}></i>{'\u00A0'}Fill the required information *
                    </div>
                </div>
            </div>
        </div>
                ...
                <div className="signin-inner">
                    ...
                    <div className="signin-inner-display">
                        ...
                        <div className="signin-signup">
                            <div className="signin-signup-inner" onClick={()=>changePage({loginpage:"none",signuppage:"block",page1:"none",page2:"none",pagevid:"none",pagepayment:"none",profilepage:"none",modaleFail:"none",modaleSuccess:"none",dealspage:"none",modalecartempty:"none"})}>
                                Not a member? Signup now
                            </div>
                        </div>
                    </div>
                    <div className="signin-close">
                        <div className="signin-close-btn" onClick={()=>changePage({loginpage:"none",signuppage:"none",page1:"block",page2:"none",pagevid:"none",pagepayment:"none",profilepage:"none",modaleFail:"none",modaleSuccess:"none",dealspage:"none",modalecartempty:"none"})}>
            ...
            <div className="signin-outer">
                <div className="signin-inner">
                    ...
                    <div className="signin-inner-display">
                        ...
                        <div className="signin-signup">
                            <div className="signin-signup-inner" onClick={()=>changePage({loginpage:"block",signuppage:"none",page1:"none",page2:"none",pagevid:"none",pagepayment:"none",profilepage:"none",modaleFail:"none",modaleSuccess:"none",dealspage:"none",modalecartempty:"none"})}>
        ...
        <div className="overall-site">
                ...
                <div className="sidepanel-mid-outer">
                    <div className="sidepanel-inner">
                        <div className="side-inner-outer">
                            <div className="side-signin" onClick={()=>{changePage({loginpage:"block",signuppage:"none",page1:"none",page2:"none",pagevid:"none",pagepayment:"none",profilepage:"none",modaleFail:"none",modaleSuccess:"none",dealspage:"none",modalecartempty:"none"})
                            ...
                            <div className="side-other">
                                ...
                                <div className="side-other-ele" onClick={()=>{changePage({loginpage:"none",signuppage:"none",page1:"none",page2:"none",pagevid:"block",pagepayment:"none",profilepage:"none",modaleFail:"none",modaleSuccess:"none",dealspage:"none",modalecartempty:"none"})
                                                                            changeSidepanle("none")
                            }}>
                                    Watch our chef cook
                                </div>
                                <div className="side-other-ele" onClick={()=>{changePage({loginpage:"none",signuppage:"none",page1:"none",page2:"none",pagevid:"none",pagepayment:"none",profilepage:"none",modaleFail:"none",modaleSuccess:"none",dealspage:"block",modalecartempty:"none"})
                                                                            changeSidepanle("none")
                            }}>
                                    Deals
                                </div>
            ...
            {/* deals */}
            <div id="dealspage" style={{display:page.dealspage}}>
                {dealsfunc(changeOrder,order,changePrice,orderprice,popup,changePopup)}
            </div>
            {/* main page */}
            <div id="main-page" style={{display:page.page1}}>
                ...
                <div id="display-text">
                    {Displaytext(changePage,changeAddress)}
                </div>


                <div id="main1">
                    {Main1(changeOrder,order,changePrice,orderprice,popup,changePopup,msg,changeMsg)}
                </div>
            </div>
            {/* cart */}
...
function Navbar(changeSidepanle,changeSearch,changeText,changePage,admin,order,Gimage,Glogin)
{
    ...
    return(
        <nav className='mera_color'>
            ...
            <input type="text" name="searchfoodsite" placeholder="Search.."className="search-bar" onFocus={e => changeSearch("block")} onChange={v=>changeText(v.target.value)} type={"text"}/>
            </div>

            <div className="right-nav">
                <div className="nav-home"  onClick={()=>changePage({loginpage:"none",signuppage:"none",page1:"none",page2:"none",pagevid:"block",pagepayment:"none",profilepage:"none",modaleFail:"none",modaleSuccess:"none",dealspage:"none",modalecartempty:"none"})}>
                    <i class="fad fa-video fa-2x"></i>
                </div>
                <div className="nav-home" onClick={()=>changePage({page1:"block",page2:"none",loginpage:"none",signuppage:"none",pagevid:"none",pagepayment:"none",profilepage:"none",modaleFail:"none",modaleSuccess:"none",dealspage:"none",modalecartempty:"none"})}>
                ...
                <div className="outernav-icon">
                    ...
                    <div className="nav-cart" onClick={()=>changePage({page1:"none",page2:"block",loginpage:"none",signuppage:"none",pagevid:"none",pagepayment:"none",profilepage:"none",modaleFail:"none",modaleSuccess:"none",dealspage:"none",modalecartempty:"none"})}>
                        <i class="fad fa-shopping-cart fa-2x"></i>
                    </div>
                </div>
                <div className="nav-profile" onClick={()=>changePage({page1:"none",page2:"none",loginpage:"none",signuppage:"none",pagevid:"none",pagepayment:"none",profilepage:"block",modaleFail:"none",modaleSuccess:"none",dealspage:"none",modalecartempty:"none"})}>
...
// deals page  #################################################
function dealsfunc(changeOrder,order,changePrice,orderprice,popup,changePopup)
{
    function weekenddealsdisplay(changeOrder,order,changePrice,orderprice,popup,changePopup)
    {
        var namelis=["Hotdog Monday", "Fried Chicken Friday", "Sandwich Saturday", "Taco Tuesday", "Oats Thursday", "Pizza Sunday","French Fries Allday","Onion Rings Wednusday"]
        var pricelis=[2.02,0.33,3.13,2.58,1.21,3.11,2.62,1.56]
        var fakepricelis=[3.02,1.33,4.13,3.58,2.21,4.11,3.62,2.56]
        var images = [hotdog, wings, sandwich, taco, oats,food6,fries, onion];
        var li = [];
        for (var i = 0; i < 8; i++) {
            li.push(weekendpush(namelis[i],pricelis[i],images[i],fakepricelis[i]));
        }
        return li
    }
    function weekendpush(name,price,image,fakeprice)
    {
        const a=<div className="main1-item-display" style={{marginLeft:"40px",marginTop:"10px"}}>
        <img src={image} className="item-display-img"/>
            <div className="item-info">
        ...
        return(
        <div className="deals-main1-item-display">
            <img src={image} className="deals-item-display-img"/>
                <div className="deals-item-info">
                <div className="deals-left-item">
                    <span className="deals-item-info-name">{name}</span>
                    <div className="prices-two">
                        <span className="deals-item-info-price">${fakeprice}</span>
                        <span className="deals-item-info-price-two">${price}</span>
                    </div>
                </div>
                <div className="deals-right-item" onMouseOut={()=>{changePopup("none")}} onClick={()=>{
    ...
    function familypackdisplay(changeOrder,order,changePrice,orderprice,popup,changePopup)
    {
        var namelis=["Quinoa","Spicy Fish","Beefy Stuffed","Broccoli Rice","Salad","Tortilla","Rs Special","Ice Cream"]
        var pricelis=[4.02,3.33,3.13,4.58,5.21,7.11,3.62,4.56]
        var fakepricelis=[5.02,4.33,4.13,5.58,6.21,6.11,4.62,5.56]
        var images = [q, fish, beef, brorice, salad,Tortilla,special, icecream];
        var li = [];
        for (var i = 0; i < 8; i++) {
            li.push(familypackpush(namelis[i],pricelis[i],images[i],fakepricelis[i]));
        }
        return li
    }
    function familypackpush(name,price,image,fakeprice)
    {
        const a=<div className="main1-item-display" style={{marginLeft:"40px",marginTop:"10px"}}>
        <img src={image} className="item-display-img"/>
            <div className="item-info">
    ...
    function dailyofferdisplay(changeOrder,order,changePrice,orderprice,popup,changePopup)
    {
        var namelis=["Fried Chicken", "French Fries", "Onion Rings", "Chicken Nugs", "Tacos", "Pizza"," Hot Dogs","Ice Cream"]
        var pricelis=[0.23,2.45,1.55,3.53,5.21,2.11,3.22,4.00]
        var fakepricelis=[1.23,3.45,2.55,4.53,6.21,3.11,4.22,5.00]
        var images = [chicken, fries, onion, chickennugs, taco,food6,hotdog, icecream];
        var li = [];
        for (var i = 0; i < 8; i++) {
            li.push(dailyofferpush(namelis[i],pricelis[i],images[i],fakepricelis[i]));
        }
        return li
    }
    function dailyofferpush(name,price,image,fakeprice)
    {
        const a=<div className="main1-item-display" style={{marginLeft:"40px",marginTop:"10px"}}>
        <img src={image} className="item-display-img"/>
            <div className="item-info">
    ...
    return(
        ...
        <div className="deals-outer">
            <div className="deals-inner-overall">
                <div className="deals-inner-top">
                    <span className="deals-heading">Deals</span>
                    <span className="deals-coupon-code">Coupon Code (50% off): MYFIRST</span>
                </div>
                <div className="deals-inner-down">
                    <div className="deals-inner-columns">
                        <div className="deals-inner-column-ele">
                            Weekend Deals
                        </div>
                        <div className="deals-inner-column-display">
                            {weekenddealsdisplay()}
                        </div>
                    </div>
                    <div className="deals-inner-columns">
...
function orderpart(order,changeOrder,orderprice,changePrice,bill,changeBill,changePage,Glogin,submitprofile)
{
    ...
    function movingtocheckout(Glogin,submitprofile,changePage,order)
    {
        if(Glogin=="1" && submitprofile=="1" && order.length>0)
        {
            changePage({page1:"none",page2:"none",loginpage:"none",signuppage:"none",pagevid:"none",pagepayment:"block",profilepage:"none",modaleFail:"none",modaleSuccess:"none",dealspage:"none",modalecartempty:"none"})
            return (<></>)
        }
        if(Glogin=="1" && submitprofile=="1" && order.length==0)
        {
            changePage({page1:"none",page2:"block",loginpage:"none",signuppage:"none",pagevid:"none",pagepayment:"none",profilepage:"none",modaleFail:"none",modaleSuccess:"none",dealspage:"none",modalecartempty:"block"})
            return (<></>)
        }
        if(Glogin=="1" && submitprofile=="0")
        {
            changePage({page1:"none",page2:"none",loginpage:"none",signuppage:"none",pagevid:"none",pagepayment:"none",profilepage:"block",modaleFail:"none",modaleSuccess:"none",dealspage:"none",modalecartempty:"none"})
            return (<></>)
        }
        if(Glogin=="0" && submitprofile=="1")
        {
            changePage({page1:"none",page2:"none",loginpage:"block",signuppage:"none",pagevid:"none",pagepayment:"none",profilepage:"none",modaleFail:"none",modaleSuccess:"none",dealspage:"none",modalecartempty:"none"})
            return (<></>)
        }
            ...
            <div className="placing-order">
                ...
                <div className="order-right">
                    <div className="order-checkout">
                        ...
                        <div className="checkout-btn" onClick={()=>movingtocheckout(Glogin,submitprofile,changePage,order)}>
                            CHECKOUT
                        </div>
                    </div>
...
function profilefunc(Gimage,Gname,Gid,Gemail,Glogin,changePhoneno,changeAccount,changeBank,changeGid,changeGemail,changePincode,changeGname,changeAddress,changeSubmitprofile,address,phoneno,account,bank,changePage)
{
    ...
    function checkinginfofill(Gname,Gemail,Gid,address,phoneno,account,bank,changeSubmitprofile,changePage)
    {
        if(Gname.length>1 && Gemail.length>1 && Gid.length>1 && address.length>1 && phoneno.length>1 && account.length>1 && bank.length>1)
        {
            ...
            changePage({loginpage:"none",signuppage:"none",page1:"none",page2:"none",pagevid:"none",pagepayment:"none",profilepage:"block",modaleFail:"none",modaleSuccess:"block",dealspage:"none",modalecartempty:"none"})
            return(<></>)
        }
        else
        {
            changePage({page1:"none",page2:"none",loginpage:"none",signuppage:"none",pagevid:"none",pagepayment:"none",profilepage:"block",modaleFail:"block",modaleSuccess:"none",dealspage:"none",modalecartempty:"none"})
            return(<></>)
        }
    }
    return(
...
// main page  ##################################################
function Displaytext(changePage,changeAddress)
{
    return(
    <div className="display-text">
        ...
        <div className="display-text-middle-div">
            ...
            <input type="text" name="addressenter" placeholder="Enter Delivery Address.."className="search-bar" style={{width:"40%",height:"95%"}} onChange={v=>changeAddress(v.target.value)} type={"text"}/>
            ...
            <div className="get-food" onClick={()=>changePage({loginpage:"none",signuppage:"none",page1:"none",page2:"none",pagevid:"none",pagepayment:"none",profilepage:"none",modaleFail:"none",modaleSuccess:"none",dealspage:"block",modalecartempty:"none"})}>
                Deals
            </div>
        </div>

        <div className="display-text-bottom-div">
            <div className="signin-option-display" onClick={()=>changePage({loginpage:"block",signuppage:"none",page1:"none",page2:"none",pagevid:"none",pagepayment:"none",profilepage:"none",modaleFail:"none",modaleSuccess:"none",dealspage:"none",modalecartempty:"none"})}>Sign In</div><span> {'\u00A0'}for ur recent address</span>
        </div>
    </div>
    )
}

function Main1(changeOrder,order,changePrice,orderprice,popup,changePopup,msg,changeMsg)
{
...
function Main3info()
{
    function bussiness()
    {
        ...
        var namelis=["Want us to deliver for you?","Want to start a bussiness ?","Wanna deliver with us?"]
...
function Main9info(msg,changeMsg)
{
    return(
        <>
            ...
            <div className="main9-outer-bottom">
                <div className="main9-bottom-text">
                    ...
                    <div className="main9-display">
                        <input type="name" placeholder="Full Name" className="contactusinput" onChange={v=>changeMsg(v.target.value)} type={"text"}/>
                        <input type="email" placeholder="Email" className="contactusinput" onChange={v=>changeMsg(v.target.value)} type={"text"}/>
                        <textarea placeholder="Your Message" className="contactusinput-textarea" onChange={v=>changeMsg(v.target.value)} type={"text"}/>
